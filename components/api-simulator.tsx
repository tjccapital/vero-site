...
const DOC_URLS: Record<number, string> = {
  1: "https://docs.digitalreceiptprotocol.org/api-reference/onboarding/generate-keys",
  2: "https://docs.digitalreceiptprotocol.org/api-reference/onboarding/register",
  3: "https://docs.digitalreceiptprotocol.org/api-reference/payments/create",
  4: "https://docs.digitalreceiptprotocol.org/api-reference/keys/grant-access",
  5: "https://docs.digitalreceiptprotocol.org/api-reference/payments/decrypt",
};
