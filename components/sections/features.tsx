      ...
      <div className="space-y-1.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "70%" }} />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "52%" }} />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "48%" }} />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "37%" }} />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "28%" }} />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-sm overflow-hidden">
            <div className="h-full bg-primary-900 rounded-sm" style={{ width: "22%" }} />
          </div>
