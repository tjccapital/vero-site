...
export const TracingBeam = ({
  ...
  const y1 = useSpring(
    useTransform(scrollYProgress, [0.25, 0.8], [50, svgHeight]),
    {
      stiffness: 500,
      damping: 90,
    }
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0.25, 1], [50, svgHeight - 200]),
    {
      stiffness: 500,
      damping: 90,
    }
      ...
      <div className="absolute -left-4 md:-left-20 top-3">
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "white" : "#1e3a8a",
              borderColor:
                scrollYProgress.get() > 0 ? "white" : "#1e3a8a",
            }}
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="#1e3a8a" stopOpacity="0"></stop>
